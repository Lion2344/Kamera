...
class ArducamClass(object):
    ...
    def Camera_Detection(self):
        print('Arducam.Camera_Detection(self)')
        while True:
    ...
    def Set_Camera_mode(self,mode):
        print(f'Arducam.Set_Camera_mode(self,mode={mode})')
        self.CameraMode=mode
    
    def wrSensorReg16_8(self,addr,val):
        print(f'Arducam.wrSensorReg16_8(self,addr={addr},val={val})')
        buffer=bytearray(3)
    ...
    def rdSensorReg16_8(self,addr):
        print(f'Arducam.rdSensorReg16_8(self,addr={addr})')
        buffer=bytearray(2)
        rt=bytearray(1)
        buffer[0]=(addr>>8)&0xff
        buffer[1]=addr&0xff
    ...
    def wrSensorReg8_8(self,addr,val):
        print(f'Arducam.wrSensorReg8_8(self,addr={addr},val={val})')
        buffer=bytearray(2)
        buffer[0]=addr
        buffer[1]=val
        self.iic_write(buffer)
    ...
    def Camera_Init(self):
        print(f'Arducam.Camera_Init(self)')
        if self.CameraType==OV2640:
            self.wrSensorReg8_8(0xff,0x01)
    ...
    def Spi_write(self,address,value):
        #3
        #8
        print(f'Arducam.Spi_write(self,address={address},value={value})')
        maskbits = 0x80
        buffer=bytearray(2)
    ...
    def Spi_read(self,address):
        print(f'Arducam.Spi_read(self,address={address})')
        maskbits = 0x7f
        buffer=bytearray(1)
        buffer[0]=address & maskbits
        self.SPI_CS_LOW()
    ...
    def spi_write(self, buf, *, start=0, end=None):
        #5
        print(f'Arducam.spi_write(self, buf, *, start=0={start}, end=None={end})')
        if end is None:
            end = len(buf)
        self.spi.write(buf, start=start, end=end)

    def spi_readinto(self, buf, *, start=0, end=None):
        print(f'Arducam.spi_readinto(self, buf, *, start=0={start}, end=None={end})')
        if end is None:
            end = len(buf)
        self.spi.readinto(buf, start=start, end=end)
        
    def get_bit(self,addr,bit):
        print(f'Arducam.get_bit(self,addr={addr},bit={bit}')
        value=self.Spi_read(addr)[0]
        return value&bit
  
    def SPI_CS_LOW(self):
        #4
        print(f'Arducam.SPI_CS_LOW(self)')
        self.SPI_CS.value=False
        
    def SPI_CS_HIGH(self):
        print('#1')
        #6
        print(f'Arducam.SPI_CS_HIGH(self)')
        self.SPI_CS.value=True
        
    def set_fifo_burst(self):
        print(f'Arducam.set_fifo_burst(self)')
        buffer=bytearray(1)
        buffer[0]=0x3c
    ...
    def clear_fifo_flag(self):
        #2
        print(f'Arducam.clear_fifo_flag(self)')
        self.Spi_write(0x04,0x01)
        
    def flush_fifo(self):
        #8
        print(f'Arducam.flush_fifo(self)')
        self.Spi_write(0x04,0x01)
        
    def start_capture(self):
        print(f'Arducam.start_capture(self)')
        self.Spi_write(0x04,0x02)
        
    def read_fifo_length(self):
        print(f'Arducam.read_fifo_length(self)')
    ...
    def wrSensorRegs8_8(self,reg_value):
        print(f'Arducam.wrSensorRegs8_8(self, reg_value={ref_value})')
    ...
    def wrSensorRegs16_8(self,reg_value):
        print(f'Arducam.wrSensorRegs16_8(self, reg_value={reg_value})')
        for data in reg_value:
            addr = data[0]
            val = data[1]
    ...
    def OV2640_set_Light_Mode(self,result):
        print(f'Arducam.OV2640_set_Light_Mode(self,result={result})')
        if result==Auto:
    ...
    def OV2640_set_Color_Saturation(self,Saturation):
        print(f'Arducam.OV2640_set_Color_Saturation(self,Saturation={Saturation})')
    ...
    def OV2640_set_Brightness(self,Brightness):
        print(f'Arducam.OV2640_set_Brightness(self,Brightness={Brightness})')
    ...
    def OV2640_set_Contrast(self,Contrast):
        print(f'Arducam.OV2640_set_Contrast(self,Contrast={Contrast})')
    ...
    def OV2640_set_Special_effects(self,Special_effect):
        print(f'Arducam.OV2640_set_Special_effects(self,Special_effect={Special_effect})')
    ...
    def OV5642_set_JPEG_size(self,size):
        print(f'Arducam.OV5642_set_JPEG_size(self,size={size})')
    ...
    def OV5642_set_Light_Mode(self,Light_Mode):
        print(f'Arducam.OV5642_set_Light_Mode(self,Light_Mode={Light_Mode})')
    ...
    def OV5642_set_Color_Saturation(self,Color_Saturation): 
        print(f'Arducam.OV5642_set_Color_Saturation(self,Color_Saturation={Color_Saturation})')    
    ...
    def OV5642_set_Brightness(self,Brightness):
        print(f'Arducam.OV5642_set_Brightness(self,Brightness={Brightness})')   
    ...
    def OV5642_set_Contrast(self,Contrast):
        print(f'Arducam.OV5642_set_Contrast(self,Contrast={Contrast})')   
    ...
    def OV5642_set_hue(self,degree):
        print(f'Arducam.OV5642_set_hue(self,degree={degree})') 
    ...
    def OV5642_set_Special_effects(self,Special_effect):
        print(f'Arducam.OV5642_set_Special_effects(self,Special_effect={Special_effect})') 
    ...
    def OV5642_set_Exposure_level(self,level):
        print(f'Arducam.OV5642_set_Exposure_level(self,level={level})') 
    ...
    def OV5642_set_Sharpness(self,Sharpness):
        print(f'Arducam.OV5642_set_Sharpness(self,Sharpness={Sharpness})') 
    ...
    def OV5642_set_Mirror_Flip(self,Mirror_Flip):
        print(f'Arducam.OV5642_set_Mirror_Flip(self,Mirror_Flip={Mirror_Flip})') 
    ...
    def OV5642_set_Compress_quality(self,quality):
        print(f'Arducam.OV5642_set_Compress_quality(self,quality={quality})') 
    ...
    def OV5642_Test_Pattern(self,Pattern):
        print(f'Arducam.OV5642_Test_Pattern(self,Pattern={Pattern})') 
